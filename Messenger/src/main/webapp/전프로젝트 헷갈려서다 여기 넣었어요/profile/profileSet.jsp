...
<form id="frm-profileSet" method="post" action="">
	<div id="profileSet">
		...
		<article class="border_article">
			<dl id="dl-ProfileSet" class="dlHover">
			 <dt>프로필 사진</dt>
			 <dd>
				<img id="img-frofile" src="https://jandi-box.com/assets/ic-profile.png">
				<button type="button" id="btn-changeProfile">수정</button>
			...
			<dl class="dlHover">
				<dt>이름</dt>
					<dd id="name-closeMode">
						유다현
						<i id="name-closeMode-btn" class="fas fa-chevron-down i-greenDown"></i>
					</dd>
					<dd id="name-openMode">	
						<i id="name-openMode-btn" class="fas fa-chevron-up i-greenUp"></i>			
						<input type="text" value="유다현">
						<br>
					 	 <button class="btn-fff">확인</button>
					  <button class="btn-ccc">취소</button>
				  </dd>
			</dl>	
			...
			<dl class="dlHover">	
			 <dt>이메일 관리</dt>
			  <dd id="email-closeMode">
				  ...
				  <i class="fas fa-chevron-down floatRigt i-greenDown"></i>
			  <dd id="email-openMode">
			  	<i id="email-openMode-btn" class="fas fa-chevron-up i-greenUp"></i>
			  	<h5>기본 이메일 주소</h5>
			 ...
			 <dl class="dlHover">	 				
				<dt>비밀번호 변경하기</dt>
			  	...
			  	<dd id="pwd-openMode">
			  		<i id="pwd-openMode-btn" class="fas fa-chevron-up i-greenUp"></i>
			  		<h5>현재 비밀번호</h5>
			  		<input type="password">
			  		<h5>새 비밀번호</h5>
			  		<input type="password">
			 ...
			 <dl class="dlHover">	
			  <dt>계정 삭제</dt>
			  	...
			  	<dd id="del-openMode">
			  		<i id="del-openMode-btn" class="fas fa-chevron-up i-greenUp"></i>		
